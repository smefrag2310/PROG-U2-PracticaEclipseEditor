...
## 4. Systax Coloring  
Es importante tener un buen contraste visual para poder diferenciar perfectamente entre mensajes, funciones, variables,etc. Forma parte de la legibilidad del código.  [SyntaxColoring.png](/capturas_ej3/SyntaxColoring.png)  
## 5. Mark Occurrences  
...
Usando **Search References** hace lo mismo pero con un alcance mayor, buscando en **todo el proyecto** y enseñando además toda la función en que se usa al completo. [MarkOccurrences.png](/capturas_ej3/MarkOccurrences.png) 
## 6. Typing  
Esto ayuda a reducir errores de escritura porque mientras hacemos código se nos puede olvidar cerrar alguna que otra llave, pero al automatizar ese proceso, hace mucho menos probable esta situación y reduce el tiempo total de trabajo, mejorando la productividad.  [Typing.png](/capturas_ej3/Typing.png) 
## 7. Templates
Las plantillas son fragmentos de código que se insertan de forma automática al escribir una palabra o literal en específico, pudiendo crear las tuyas propias además de las que trae eclipse. Para gestionarlas en eclipse debes seguir la siguiente ruta: **Window -> Preferences -> Java -> Editor -> Templates**  [Templates.png](/capturas_ej3/Templates.png)
## El de más utilidad  
